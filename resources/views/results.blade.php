			...
			<div class="page-header">
				<div class="panel panel-info">
					...
					<div class="panel-body">
						<h4 style="text-transform: none; line-height:1.6em;"> <?=$resultMessage;?></h4><br><p class="lead">Results are sorted from lowest score to highest. Total score is <span id="scoreTotal"></span></p>
					</div>
				</div>
				...
				<div class="panel panel-info">
					<div class="panel-heading">
						<h3 class="panel-title">All data is presented below.</h3>
					</div>
					<div class="panel-body">
						<h4 style="text-transform: none; line-height:1.6em;"> <?=$resultMessage;?></h4><br><p class="lead">Results are sorted from lowest score to highest. The table below should provide you with all the information necessary to understand why certain links count as they did.  Management established that rel=nofollow links will be worth 0.25 "points" as compared to 1 point for a "clean" link. Total score is <span id="scoreTotal"></span></p>
					</div>
				</div>
